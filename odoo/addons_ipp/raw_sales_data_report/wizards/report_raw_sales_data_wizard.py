...
class ReportRowDataWizard(models.TransientModel):
    _name = 'report.raw.sales.data.wizard'
    _description = 'Report Raw Sales Data Wizard'
    ...
    def generate_info(self, sheet, workbook, value):
        ...
        for line in value:
            ...
            sheet.write(row, col_line + 17, line.get('discount', ''), data_body_num_fmt)
            sheet.write(row, col_line + 18, line.get('price_total', ''), data_body_num_fmt)
